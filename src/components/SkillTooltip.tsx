      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-72 p-4 bg-gray-900 text-white rounded-lg shadow-2xl z-[100] border border-gray-700 pointer-events-none"
          >
            ...
            <div className="absolute top-full left-1/2 -translate-x-1/2 w-2 h-2 bg-gray-800 rotate-45 border-r border-b border-gray-700 -mt-1" />
          </motion.div>
        )}
      </AnimatePresence>
    </div>
